...
/**
  ...
  ******************************************************************************
  *
  * Ejemplo de uso del Temporizador de propósito general TIM3 - Interrupt mode
  *
  * Slave Mode:         Disable
  ...
  *
  * TIM2 Global Interrup: Enabled
  * Preemption Priority: 0, Sub Priority: 0
  *
  * APB1 Timers Clocks: 64 MHz
  *
  * TIM2 Frecuencia conteo:         (64MHz/(64000)) = 1KHz
  * TIM2 Frecuencia desbordamiento: (64MHz/(64000 * 1000)) = 1Hz
  * TIM2 Periodo desbordamiento:    1 secs
  ******************************************************************************
  */
...
int main(void)
{
  ...
  printLine("* Temporizador Timer 3 - TIM3 - Interrupt mode (modo IRQ)     *");
